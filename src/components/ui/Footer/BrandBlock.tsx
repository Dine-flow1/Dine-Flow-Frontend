...
function SocialLink({ icon, label }: { icon: string; label: string }) {
  return (
    <a href="#" className="p-2 text-gray-400 transition-colors rounded-lg hover:text-white hover:bg-gray-800">
      ...
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" dangerouslySetInnerHTML={{ __html: icon }} />
    </a>
  );
}
...
const instagramIcon = `<path fillRule="evenodd" d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.7-3.061-1.745-.612-1.044-.612-2.322 0-3.366.613-1.045 1.764-1.745 3.061-1.745s2.448.7 3.061 1.745c.612 1.044.612 2.322 0 3.366-.613 1.045-1.764 1.745-3.061 1.745z" clipRule="evenodd"/>`;
